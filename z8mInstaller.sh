...
SUBLIME_PACKAGES='["BracketHighlighter", "CSScomb", "EditorConfig", "GitGutter", "Package Control", "Sass", "SublimeCodeIntel", "SublimeLinter", "SublimeLinter-contrib-scss-lint", "SublimeLinter-csslint", "SublimeLinter-jscs", "SublimeLinter-jshint", "SublimeLinter-jsxhint", "SublimeOnSaveBuild"]'
